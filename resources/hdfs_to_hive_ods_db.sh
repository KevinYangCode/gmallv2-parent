...
sql2=" 
use ${APP};
load data inpath '/origin_data/$APP/db/base_province/$do_date' overwrite into table ods_base_province; 

load data inpath '/origin_data/$APP/db/base_region/$do_date' overwrite into table ods_base_region; 
"
